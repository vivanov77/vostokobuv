...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { optext: @opinion.optext, references: @opinion.references } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { optext: @opinion.optext, references: @opinion.references } }
