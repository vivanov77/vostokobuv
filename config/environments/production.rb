Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "vostokobuv_#{Rails.env}"
...
# http://stackoverflow.com/questions/4114835/heroku-devise-missing-host-to-link-to-please-provide-host-parameter-or-set-d
  config.action_mailer.default_url_options = {host: ENV['DYNO'].blank? ? 'xn----btbbc1bxacxkq3i.xn--p1ai' : 'vostok-obuv.herokuapp.com'}
