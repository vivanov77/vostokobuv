class Admin::UserNewsController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_news.save
        format.html { redirect_to [:admin, @user_news], notice: 'Пользовательская новость была успешно создана.' }
  ...
  def update
    respond_to do |format|
      if @user_news.update(user_news_params)
        format.html { redirect_to [:admin, @user_news], notice: 'Пользовательская новость была успешно обновлена.' }
  ...
  def destroy
    @user_news.destroy
    respond_to do |format|
      format.html { redirect_to admin_user_news_index_url, notice: 'Пользовательская новость была успешно удалена.' }
